...
const Hero = () => {
  return (
      <Padding classes={'bg-brandblack'}>
        <div className="font-gilroy flex flex-col justify-center text-center items-center text-white text-[2.2rem] font-medium lg:text-[3rem] 2xl:text-[6rem] gap-4 lg:gap-9 min-h-[120vh] sm:min-h-[120vh]  lg:min-h-[160vh] xl:min-h-[140vh] 2xl:min-h-[150vh] leading-1">
